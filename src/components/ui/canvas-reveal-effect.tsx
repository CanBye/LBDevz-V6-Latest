...
import type { ShaderUniforms, ShaderProps, DotMatrixProps, CanvasRevealEffectProps } from "@/types";
...
export const CanvasRevealEffect: React.FC<CanvasRevealEffectProps> = ({
  ...
  const shaderFlag = `${reverse ? "u_reverse_active" : "false"}_;animation_speed_factor_${animationSpeed.toFixed(1)}_;`;
